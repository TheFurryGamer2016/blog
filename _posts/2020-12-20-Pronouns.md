...
<ul class="plain inline content-replacer chips" data-replaced-element-selector="[data-español-gender]" data-content-replacer-data-source="español-gender" data-content-replacer-data-replacement="gendered-español">
    <li><button class="chip mutates-page" data-gendered-español="nonGendered" selected>non-gendered</button></li>
    <li><button class="chip mutates-page" data-gendered-español="genderedMasculine">gendered (masculine)</button></li>
    <li><button class="chip mutates-page" data-gendered-español="genderedFeminine">gendered (feminine)</button></li>
</ul>
